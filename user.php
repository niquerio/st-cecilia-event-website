...
if (!isset($_POST['edit_user']) OR count($edit) < 1) {
...
<form class="form" method="post" action="user.php">
    ...
    <ul>
        ...
        <li><label for="group_id">SCA Local Group:</label><?php $db= new db(); $result=$db->get_list('cecilia.group');
            $index = $edit['group_id'];
