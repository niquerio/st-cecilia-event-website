...
//        AND $mysqli = new mysqli(DB_HOST, DB_USER, DB_PASS, DB_NAME)
    ...
    function insert_master_schedule($name, $kwds, $room, $begin, $end) { //, $estimate, $useEnd, $ordinal) {
        $this->query(
        ...
        $nickname, /**$password,**/ $phone, $prefix, $sca_first, $sca_last, $state, $title, $username, $zip)
    {
        ...
        mail('gwommy@gmail.com', 'New Registered User for KWDS',
        ...
        $parking, $proceeding, $start_date, $state, $status, $zip)
    {
       ...
       $zip = mysqli_real_escape_string($this->connection, $zip); 
        return $this->query(
            "UPDATE kwds SET address='$address', attractions='$attraction', concerts='$concerts', banner='$banner', city='$city',
